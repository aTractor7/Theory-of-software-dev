...
@Component
public class ChangeUserFoundsAbstractFinancialArrangementServiceDecorator extends AbstractFinancialArrangementServiceDecorator {
    ...
    @Autowired
    public ChangeUserFoundsAbstractFinancialArrangementServiceDecorator(FinancialArrangementService financialArrangementService,
